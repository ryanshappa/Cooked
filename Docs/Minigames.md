...
### Sauce spreading (pizza, condiments)
- **Verb:** hold ladle/squeeze bottle, move over the dough/bun to paint sauce.
...
### Assembly (burgers, plating)
- **Verb:** physically stack components on the plate/bun; snap-with-tolerance (magnetic assist inside a tolerance radius so it's tactile, not rage-inducing).
